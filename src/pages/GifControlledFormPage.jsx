...
const GifControlledFormPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const { keyword, random, limit } = e.target;

    prepareData(keyword.value, random.checked, limit.value * 1);
  };
...
export default GifControlledFormPage;
